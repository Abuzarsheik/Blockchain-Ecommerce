    ...
    const mockNotifications = [
      {
        ...
        type: 'order',
        title: 'Order Shipped',
        message: 'Your NFT "Digital Sunset #123" has been shipped',
      ...
      },
      {
        ...
        type: 'review',
        title: 'New Review',
        message: 'You received a 5-star review for "Abstract Art Collection"',
      ...
      },
      {
        ...
        type: 'message',
        title: 'New Message',
        message: 'You have a new message from buyer about "Cyber Punk NFT"',
      ...
      },
      {
        ...
        type: 'alert',
        title: 'Price Alert',
        message: 'NFT you\'re watching dropped in price by 15%',
